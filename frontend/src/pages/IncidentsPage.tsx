...
export default function IncidentsPage() {
  useEffect(() => {
    document.title = "KAVACH Incident Management - MeitY";

    const head = document.head;
    const notoId = "kavach-noto-font";
    const materialId = "kavach-material-font";
    ...
    if (!document.getElementById(notoId)) {
      ...
      link.rel = "stylesheet";
      link.href =
        "https://fonts.googleapis.com/css2?family=Noto+Sans:wght@300;400;500;600;700&family=JetBrains+Mono:wght@400;600&display=swap";
  ...
  return (
    <>
      ...
      <div className="bg-slate-50 text-slate-900 flex overflow-hidden h-screen">
        <aside className="w-[248px] bg-[var(--navy-primary)] text-white flex-shrink-0 flex flex-col h-full z-30 shadow-xl">
          <div className="h-16 flex items-center px-6 bg-[var(--navy-dark)]">
            <h1 className="text-xl font-bold tracking-widest text-white">KAVACH</h1>
          </div>
          <div className="flex-1 py-6">
            <nav className="space-y-1">
              <a className="flex items-center gap-3 px-6 py-3 text-white/70 hover:bg-white/5 transition-colors" href="#">
                <span className="material-symbols-outlined">dashboard</span>
                <span>Dashboard</span>
              </a>
              <a className="flex items-center justify-between px-6 py-3 bg-white/15 border-l-[3px] border-white text-white font-medium" href="#">
                <div className="flex items-center gap-3">
                  <span className="material-symbols-outlined">shield_with_heart</span>
                  <span>Incidents</span>
                </div>
                <span className="bg-[#b71c1c] text-[10px] font-bold px-1.5 py-0.5 rounded">12</span>
              </a>
              <a className="flex items-center gap-3 px-6 py-3 text-white/70 hover:bg-white/5 transition-colors" href="#">
          ...
          <div className="p-6 border-t border-white/10 bg-[var(--navy-dark)]/50">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-lg bg-[var(--navy-primary)] border border-white/20 flex items-center justify-center font-bold text-sm">JS</div>
              <div className="flex flex-col">
                <p className="text-sm font-semibold">Amit Verma</p>
                <p className="text-[10px] text-white/60 uppercase tracking-tighter">Joint Secretary</p>
              </div>
            </div>
          </div>
        </aside>
                  ...
                  <tr className="critical-row">
                    ...
                    <td className="px-4 py-4">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="bg-[var(--bg-pill-red)] text-[var(--govt-red)] px-2 py-0.5 rounded text-[10px] font-bold border border-red-100">CRITICAL</span>
